/*
 ...
 Source Schema         : ssm_cake

 Target Server Type    : MySQL
 Target Server Version : 80032 (8.0.32)
 File Encoding         : 65001

 Date: 02/05/2023 09:35:02
*/
...
-- Records of admins
-- ----------------------------
INSERT INTO `admins` VALUES (1, '3', 'HAMVRZRssPCADKqGjGWJtQ==', 'HAMVRZRssPCADKqGjGWJtQ==');
...
CREATE TABLE `goods`  (
  ...
  `image1` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '细节图片1',
  `image2` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '细节图片2',
  `price` int NULL DEFAULT NULL COMMENT '价格',
  `intro` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '介绍',
  `stock` int NULL DEFAULT 0 COMMENT '库存',
  `type_id` int NULL DEFAULT NULL COMMENT '分类',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `orders`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `total` int NULL DEFAULT NULL COMMENT '总价',
  `amount` int NULL DEFAULT NULL COMMENT '商品总数',
  `status` tinyint NULL DEFAULT 1 COMMENT '订单状态(1未付款/2已付款/3已发货/4已完成)',
  `paytype` tinyint NULL DEFAULT 0 COMMENT '支付方式 (1微信/2支付宝/3货到付款)',
  `name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '收货人',
  `phone` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '收货电话',
...
CREATE TABLE `tops`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `type` tinyint NULL DEFAULT NULL COMMENT '推荐类型(1条幅/2大图/3小图)',
  `good_id` int NULL DEFAULT NULL COMMENT '蛋糕id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '首页推荐商品' ROW_FORMAT = Dynamic;
